...
if __name__ == '__main__':
    ...
    parser.add_argument('--agent_file', default = '../data/trained_agents/6max_single/gen_300/bots/1/bot_1_flat.pkl', type=str, help='Path to file of a trained agent (in flat format).')
