...
nb_generations = 250
bot_id = 1
gen_dir='../data/simul_data/simul_0/gen_0'
...
gen_rand_bots(simul_id = simul_id, gen_id=0, log_dir=log_dir, ga_popsize = ga_popsize, network=my_network, overwrite=True)
...
mutant_flat = mutate_bots(orig_bots_flat=[get_flat_params(lstm_bot.full_dict)], nb_new_bots=1,
                                          mut_rate=0.15, mut_strength=0.26)[0]
