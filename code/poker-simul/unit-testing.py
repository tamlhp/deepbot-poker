...
parser.add_argument('--gen_id', default=0, type=int, help='The generation to test.')

args = parser.parse_args()
simul_id = args.simul_id
log_dir = args.log_dir
gen_id = args.gen_id
file = open(log_dir+'/simul_'+str(simul_id)+"/configuration_details.txt",'r')
"""
...
nb_generations = 250
bot_id = 1
gen_dir='../../data/simul_data/simul_-1/gen_1'
...
parent_correct=True
for key in lstm_cross.full_dict.keys():
