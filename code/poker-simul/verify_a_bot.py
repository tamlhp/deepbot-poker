...
earnings = run_one_game_rebuys(simul_id = -1 , gen_id = -1, lstm_bot=lstm_bot, log_dir = './simul_data', nb_hands = 500, ini_stack = 3000, sb_amount = 50, opponents = 'default', verbose=False, cst_decks=cst_decks)
...
bot_id = 1
gen_dir='./simul_data/simul_0/gen_0'
backed_gen_dir = '../../../backed_simuls/simul_9/gen_15'
...
while True:
    ...
    config.register_player(name='callbot', algorithm=EquityBot())
...
game_result, last_two_players = start_poker(config, verbose=1, cheat = True,cst_deck_ids = cst_decks.copy())
time_2 = time.time()
