...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_env', default='default', type=str, help='Environment used in training (table size, game type and opponents). Default will select according to the neural network [default, hu_cash_mixed, 6max_sng_ruler, 6max_sng_mixed]')
    ...
    parser.add_argument('--log_dir', default='../data/training_data', type=str, help='The path of the file where the simulation data will be stored.')
